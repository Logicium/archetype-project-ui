...
<template>
  <section>
    ...
    <table v-if="sites.length">
      <thead>
        <tr><th>Slug</th><th>Archetype</th><th>Status</th><th>URL</th><th>Actions</th></tr>
      </thead>
      <tbody>
...
button { padding: 0.3rem 0.6rem; background: #f5f5f5; color: #0f0f10; border: none; border-radius: 4px; cursor: pointer; font: inherit; font-size: 0.85rem; font-weight: 500; }
